...
function binder(driver) {
  return {
    ...
    untilElementsLocatedByName: _untilElementsLocated.untilElementsLocatedByName.bind(this, driver),
    untilElementsLocatedById: _untilElementsLocated.untilElementsLocatedById.bind(this, driver),
    untilElementsLocatedByClass: _untilElementsLocated.untilElementsLocatedByClass.bind(
      this,
      driver,
    ),
    untilElementsLocated: _untilElementsLocated.untilElementsLocated.bind(this, driver),
    untilElementLocatedByXpath: _untilElementLocated.untilElementLocatedByXpath.bind(this, driver),
    untilElementLocatedByTagName: _untilElementLocated.untilElementLocatedByTagName.bind(
      this,
      driver,
    ),
    untilElementLocatedByName: _untilElementLocated.untilElementLocatedByName.bind(this, driver),
    untilElementLocatedById: _untilElementLocated.untilElementLocatedById.bind(this, driver),
    untilElementLocatedByClass: _untilElementLocated.untilElementLocatedByClass.bind(this, driver),
    untilElementLocated: _untilElementLocated.untilElementLocated.bind(this, driver),
    findElement: _findElement.findElement.bind(this, driver),
    findElementByXpath: _findElement.findElementByXpath.bind(this, driver),
    findElementByTagName: _findElement.findElementByTagName.bind(this, driver),
    ...
    findElementsByTagName: _findElements.findElementsByTagName.bind(this, driver),
    ...
    switchToDefaultContent: _utilities.switchToDefaultContent.bind(this, driver),
